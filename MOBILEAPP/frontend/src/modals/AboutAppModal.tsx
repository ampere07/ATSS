                        ...
                        <View style={styles.contentContainer}>
                            ...
                            <View style={styles.logoContainer}>
                                {logoUrl ? (
                                    ...
                                    <View style={[styles.logoPlaceholder, { backgroundColor: colorPalette?.primary || '#ef4444' }]}>
                                        <Text style={styles.logoPlaceholderText}>AKM</Text>
                                    </View>
                                )}
                            </View>
                            ...
                            <View style={styles.textSection}>
                                ...
                                <Text style={styles.mainDescription}>
                                    Get ready to upgrade your internet experience with AKM Telecommunication Services. Enjoy lightning-fast fiber connectivity for homes and businesses. Experience the reliability and speed you deserve. Discover our high-speed internet solutions now!
                                </Text>
                            </View>
